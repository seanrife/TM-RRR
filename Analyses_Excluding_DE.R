...
originalLabNames_DV1 <- vector()
primaryLabNames_DV1 <- vector()
primaryLabNames_DV2 <- vector()
secondaryLabNames_DV1 <- vector()
secondaryLabNames_DV2 <- vector()
...
for (lab in labIDs) {
  ...
  # Skip labs with no only German-language responses
  if (labInfo$language[labInfo$labID==lab] == "German") next
  ...
  if (lab != "METAlab") { # Skip lab without enough participants in each category
    originalLabNames_DV1 <- c(originalLabNames_DV1, labID_name_mappings$labname_short[labID_name_mappings$labID == lab])
  ...
  # Calculate tests/stats for primary analysis
  primaryLabNames_DV1 <- c(primaryLabNames_DV1, labID_name_mappings$labname_short[labID_name_mappings$labID == lab])
  ...
  primaryLabNames_DV2 <- c(primaryLabNames_DV2, labID_name_mappings$labname_short[labID_name_mappings$labID == lab])
  ...
  if (lab != "METAlab") { # Skip lab without enough participants in each category
    secondaryLabNames_DV1 <- c(secondaryLabNames_DV1, labID_name_mappings$labname_short[labID_name_mappings$labID == lab])
  ...
  secondaryLabNames_DV2 <- c(secondaryLabNames_DV1, labID_name_mappings$labname_short[labID_name_mappings$labID == lab])
...
forest(x = c(THes, ORIGINAL_DV1_metaVecES), sei = c(THse, ORIGINAL_DV1_metaVecSE), xlab="Mean difference", cex.lab=1.2,
       ...
       rows=c(length(originalLabNames_DV1)+7, (length(originalLabNames_DV1)+2):3),
       slab = c("Original Study", originalLabNames_DV1), #ExperimentalPsychologyLab 
       ylim=c(-2, length(originalLabNames_DV1)+11),
       xlim = c(-1.9, 2.2))

abline(h=length(originalLabNames_DV1)+5, lwd=1.4)
text(grconvertX(.019, from = "ndc", "user"), length(originalLabNames_DV1)+3.75, "RRR Studies", cex=1.2, pos = 4)
text(grconvertX(.053, from = "ndc", "user"), length(originalLabNames_DV1)+10, "Study", cex=1.2)
text(grconvertX(.24, from = "ndc", "user"), length(originalLabNames_DV1)+10, "Delay", cex=1.2)
text(grconvertX(.32, from = "ndc", "user"), length(originalLabNames_DV1)+10, "Other", cex=1.2)
text(grconvertX(.875, from = "ndc", "user"), length(originalLabNames_DV1)+10, paste0("Mean difference", " [95% CI]"), cex=1.2)
...
ggsave(paste0(outDir, "/excluding_de_ORIGINAL_WG_line-graphs.png"), dpi=600)
...
ggsave(paste0(outDir, "/excluding_de_ORIGINAL_WC_line-graphs.png"), dpi=600)
...
ggsave(paste0(outDir, "/excluding_de_ORIGINAL_WG_loess-graphs.png"), dpi=600)
...
ggsave(paste0(outDir, "/excluding_de_ORIGINAL_WC_loess-graphs.png"), dpi=600)
...
forest(x = PRIMARY_DV1_metaVecES, sei = PRIMARY_DV1_metaVecSE, xlab="Mean difference", cex.lab=1.4,
       ...
       ylim=c(-2, length(primaryLabNames_DV1)+3),
       xlim=c(-1.7, 1.7),
       slab = primaryLabNames_DV1)

text(grconvertX(.053, from = "ndc", "user"), length(primaryLabNames_DV1)+2, "Study", cex=1.2)
text(grconvertX(.22, from = "ndc", "user"), length(primaryLabNames_DV1)+2, "Pain", cex=1.2)
text(grconvertX(.30, from = "ndc", "user"), length(primaryLabNames_DV1)+2, "Death", cex=1.2)
text(grconvertX(.87, from = "ndc", "user"), length(primaryLabNames_DV1)+2, paste0("Mean difference", " [95% CI]"), cex=1.2)
...
forest(x = PRIMARY_DV2_metaVecES, sei = PRIMARY_DV2_metaVecSE, xlab="Mean difference", cex.lab=1.4,
       ...
       ylim=c(-2, length(primaryLabNames_DV2)+3),
       xlim=c(-4.4, 4.5),
       slab = primaryLabNames_DV2)

text(grconvertX(.053, from = "ndc", "user"), length(primaryLabNames_DV2)+2, "Study", cex=1.2)
text(grconvertX(.22, from = "ndc", "user"), length(primaryLabNames_DV2)+2, "Pain", cex=1.2)
text(grconvertX(.3, from = "ndc", "user"), length(primaryLabNames_DV2)+2, "Death", cex=1.2)
text(grconvertX(.87, from = "ndc", "user"), length(primaryLabNames_DV2)+2, paste0("Mean difference", " [95% CI]"), cex=1.2)
...
forest(x = SECONDARY_DV1_metaVecES, sei = SECONDARY_DV1_metaVecSE, xlab="Mean difference", cex.lab=1.4,
       ...
       cex.axis=1.1,
       lwd=1.4,
       ylim=c(-2, length(secondaryLabNames_DV1)+3),
       xlim=c(-2.85, 1.4),
       slab = secondaryLabNames_DV1)

text(grconvertX(.053, from = "ndc", "user"), length(secondaryLabNames_DV1)+2, "Study", cex=1.2)
text(grconvertX(.22, from = "ndc", "user"), length(secondaryLabNames_DV1)+2, "No Delay", cex=1.2)
text(grconvertX(.3, from = "ndc", "user"), length(secondaryLabNames_DV1)+2, "Delay", cex=1.2)
text(grconvertX(.87, from = "ndc", "user"), length(secondaryLabNames_DV1)+2, paste0("Mean difference", " [95% CI]"), cex=1.2)
...
forest(x = SECONDARY_DV2_metaVecES, sei = SECONDARY_DV2_metaVecSE, xlab="Mean difference", cex.lab=1.4,
       ...
       ilab.xpos=c(grconvertX(.22, from = "ndc", "user"),
                   grconvertX(.3, from = "ndc", "user")), cex.axis=1.1, lwd=1.4,
       ylim=c(-2, length(secondaryLabNames_DV2)+3),
       xlim=c(-3.9, 2.7),
       slab = secondaryLabNames_DV2)

text(grconvertX(.053, from = "ndc", "user"), length(secondaryLabNames_DV2)+2, "Study", cex=1.2)
text(grconvertX(.22, from = "ndc", "user"), length(secondaryLabNames_DV2)+2, "No Delay", cex=1.2)
text(grconvertX(.3, from = "ndc", "user"), length(secondaryLabNames_DV2)+2, "Delay", cex=1.2)
text(grconvertX(.87, from = "ndc", "user"), length(secondaryLabNames_DV2)+2, paste0("Mean difference", " [95% CI]"), cex=1.2)
