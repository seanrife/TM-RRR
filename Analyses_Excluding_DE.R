...
labInfo <- labInfo[!grepl("German", labInfo$language, fixed = TRUE),]
...
write.csv(ORIGINAL_DV1_descriptives, paste0(outDir, "/de_excluded_ORIGINAL_WG_descriptives.csv"), row.names = F)
write.csv(PRIMARY_DV1_descriptives, paste0(outDir, "/de_excluded_PRIMARY_WG_descriptives.csv"), row.names = F)
write.csv(PRIMARY_DV2_descriptives, paste0(outDir, "/de_excluded_PRIMARY_WC_descriptives.csv"), row.names = F)
write.csv(SECONDARY_DV1_descriptives, paste0(outDir, "/de_excluded_SECONDARY_WG_descriptives.csv"), row.names = F)
write.csv(SECONDARY_DV2_descriptives, paste0(outDir, "/de_excluded_SECONDARY_WC_descriptives.csv"), row.names = F)
write.csv(labInfo, paste0(outDir, "/de_excluded_labDescriptives.csv"), row.names = F)

# Meta analysis (between groups)
sink(paste0(outDir, "/de_excluded_ma-original-WG-bg.txt"))
...
sink(paste0(outDir, "/de_excluded_ma-original-WG-cont.txt"))
...
Cairo(file=paste0(outDir, "/de_excluded_forest_original_WG.png"), 
      bg="white",
      type="png",
      units="in", 
      width=11, height=9, 
...
ggsave(paste0(outDir, "/de_excluded_ORIGINAL_WG_line-graphs.png"))
...
ggsave(paste0(outDir, "/de_excluded_ORIGINAL_WC_line-graphs.png"))
...
ggsave(paste0(outDir, "/de_excluded_ORIGINAL_WG_loess-graphs.png"))
...
ggsave(paste0(outDir, "/de_excluded_ORIGINAL_WC_loess-graphs.png"))


#### PRIMARY ANALYSES ####

# Meta analysis (word generation)
sink(paste0(outDir, "/de_excluded_ma-primary-WG.txt"))
...
sink(paste0(outDir, "/de_excluded_ma-primary-WC.txt"))
...
Cairo(file=paste0(outDir, "/de_excluded_forest_primary_WG.png"), 
      bg="white",
      type="png",
      units="in", 
      width=11, height=9, 
...
Cairo(file=paste0(outDir, "/de_excluded_forest_primary_WC.png"), 
      bg="white",
      type="png",
      units="in", 
      width=11, height=9, 
...
Cairo(file=paste0(outDir, "/de_excluded_forest_secondary_WG.png"), 
      bg="white",
      type="png",
      units="in", 
      width=11, height=9, 
...
Cairo(file=paste0(outDir, "/de_excluded_forest_secondary_WC.png"), 
      bg="white",
      type="png",
      units="in", 
      width=11, height=9, 
